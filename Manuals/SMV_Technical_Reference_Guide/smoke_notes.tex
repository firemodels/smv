...
\begin{center}
\begin{tabular}{l}
\includegraphics[height=3.75in]{SCRIPT_FIGURES/tdemo_sidev1_005}\\
a) slices skipped and oriented along the `X' directions\\
\includegraphics[height=3.75in]{SCRIPT_FIGURES/tdemo_fullv1_005}\\
...
\begin{figure}[bph]
\begin{center}
\includegraphics[height=3.75in]{SCRIPT_FIGURES/tdemo_fullv2_005}
\end{center}
\caption
{Realistic visualization of a townhouse
