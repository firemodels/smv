...
perpendicular to the view direction. Figure \ref{figsmoke3dfullv2} shows smoke planes 
oriented along YZ planes but viewed down the X axis so the individual planes are not seen.
The smoke planes in this figure are oriented the same as in Figure \ref{figsmoke3d}a.

\begin{figure}[bph]
\begin{center}
\begin{tabular}{l}
\includegraphics[height=3.75in]{../SMV_User_guide/SCRIPT_FIGURES/tdemo_sidev1_005}\\
a) slices skipped and oriented along the `X' directions\\
\includegraphics[height=3.75in]{../SMV_User_guide/SCRIPT_FIGURES/tdemo_fullv1_005}\\
...
\begin{figure}[bph]
\begin{center}
\includegraphics[height=3.75in]{../SMV_User_guide/SCRIPT_FIGURES/tdemo_fullv2_005}
\end{center}
\caption
{Realistic visualization of a townhouse
kitchen fire simulated using FDS viewed along the X axis.}
\label{figsmoke3dfullv2}%
\end{figure}
