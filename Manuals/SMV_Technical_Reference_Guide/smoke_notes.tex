...
\begin{center}
\begin{tabular}{l}
\includegraphics[height=3.75in]{SCRIPT_FIGURES/tdemo_sidev1_010s}\\
a) slices skipped and oriented along the `X' directions\\
\includegraphics[height=3.75in]{SCRIPT_FIGURES/tdemo_fullv1_010s}\\
...
\begin{figure}[bph]
\begin{center}
\includegraphics[height=3.75in]{SCRIPT_FIGURES/tdemo_fullv2_010s}
\end{center}
\caption
{Realistic visualization of a townhouse
