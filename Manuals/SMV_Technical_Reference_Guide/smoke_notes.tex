...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=6.0in]{\SMVTGfigdir/rte_setup}
\end{center}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=5.0in]{\SMVTGfigdir/smoke_discrete_setup}
\end{center}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=4.0in]{\SMVTGfigdir/smoke_setup3}
\end{center}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=5.0in]{\SMVTGfigdir/colorbar_fire2}
\end{center}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=4.0in]{\SMVTGfigdir/smoke_setup}
\end{center}
...
\begin{figure}[bph]
\centerline{\includegraphics[width=3.5in]{\SMVTGfigdir/forney_figure4}}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=4.0in]{\SMVTGfigdir/splume_20_27}&
\includegraphics[height=4.0in]{\SMVTGfigdir/splume_17_27}\\
8 slices&11 slices\\
\includegraphics[height=4.0in]{\SMVTGfigdir/splume_14_27}&
\includegraphics[height=4.0in]{\SMVTGfigdir/splume_11_27}\\
...
\begin{center}
\begin{tabular}{l}
\includegraphics[height=3.75in]{\SMVTGfigdir/thouse5c_skip}\\
a) slices skipped and oriented along `X' directions\\
\includegraphics[height=3.75in]{\SMVTGfigdir/thouse5c_full}\\
...
\begin{figure}
\begin{tabular}{ccc}
\includegraphics[width=2.25in]{\SMVTGfigdir/figDIR1a}&
\includegraphics[width=2.25in]{\SMVTGfigdir/figDIR1b}&
\includegraphics[width=2.25in]{\SMVTGfigdir/figDIR1c}\\
...
\begin{figure}
\centerline{\includegraphics[width=3.0in]{\SMVTGfigdir/figDIR2}}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=6.5in]{\SMVTGfigdir/smoke_setup2}
\end{center}
...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=3.5in]{\SMVTGfigdir/vis_test2_nonfreeze}\\
a) normal view as seen by the observer
\end{tabular}
\begin{tabular}{cc}
\includegraphics[width=3.5in]{\SMVTGfigdir/vis_test2_freezeC}&
\includegraphics[width=3.5in]{\SMVTGfigdir/vis_test2_freezeA}\\
