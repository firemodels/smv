...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=5.0in]{SCRIPT_FIGURES/smokegeom_smoke}
\end{center}
\caption[smoke]
{smoke}
\label{fig:smoke}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=5.0in]{SCRIPT_FIGURES/smokegeom_fullbox}
\end{center}
\caption[fullbox]
{fullbox}
\label{fig:fullbox}
...
\begin{figure}[bph]
\begin{center}
\includegraphics[width=5.0in]{SCRIPT_FIGURES/smokegeom_smokebox}
\end{center}
\caption[smokebox]
{smokebox}
\label{fig:smokebox}
