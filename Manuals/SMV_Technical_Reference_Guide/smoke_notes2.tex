...
One solution to this as illustrated in Figure~\ref{fig:blendedmaximages} is use choose maximum values rather than blending values.  A better solution is to use data with
