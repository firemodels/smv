...
GLUTAPI int APIENTRY glutCreateNoCloseWindow(const char *title);   //gpf
#if defined(_WIN32) && !defined(GLUT_DISABLE_ATEXIT_HACK)
...
#endif
#endif
GLUTAPI int APIENTRY glutCreateNoCloseSubWindow(int win, int x, int y, int width, int height); //gpf
