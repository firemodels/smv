...
#define FILE_EXISTS(a)         FileExists(a,NULL,0)
#define FILE_EXISTS_CASEDIR(a) FileExists(a,filelist_casedir,nfilelist_casedir)
...
EXTERNCPP filelistdata *FileInList(char *file, filelistdata *filelist, int nfiles);
