...
#ifdef pp_PARTFRAME
  if(parti->frameinfo!=NULL&&parti->frameinfo->bufferinfo!=NULL){
...
#ifdef pp_PARTFRAME
  parti->frameinfo = FRAMELoadFrameData(parti->frameinfo, parti->file, NULL, load_flag, time_frame, GetPartFrameInfo);
