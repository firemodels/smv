...
void DrawVerticalColorbarRegLabels(void){
  ...
  if(showsmoke == 1 && parttype != 0){
    ...
    Floats2Strings(colorbar_labels, colorbar_vals, nrgb-1, ncolorlabel_digits, force_fixedpoint, force_exponential, force_decimal, exp_factor_label);
  ...
  if(showplot3d == 1){
    ...
    if(visiso == 0){
      ...
      Floats2Strings(colorbar_labels, colorbar_vals, nrgb-2, ncolorlabel_digits, force_fixedpoint, force_exponential, force_decimal, exp_factor_label);
      max_colorbar_label_width = MAX(max_colorbar_label_width, GetStringWidth(exp_factor_label));
      for(i = 0; i < nrgb - 2; i++){
