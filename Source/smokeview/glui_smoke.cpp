...
extern "C" void GLUI3dSmokeSetup(int main_window){
  ...
  CHECKBOX_load_parallel = glui_3dsmoke->add_checkbox_to_panel(PANEL_overall, _("load in parallel"), &use_smoke_threads);
#ifdef pp_SMOKE16
  if(have_smoke16 == 1){
...
#endif
  SPINNER_smoke3d_threads = glui_3dsmoke->add_spinner_to_panel(PANEL_overall, _("threads"), GLUI_SPINNER_INT, &n_smoke_threads);
