...
extern "C" void GLUIStereoSetup(int main_window){
  ...
  RADIOBUTTON_1=glui_stereo->add_radiobutton_to_group(RADIO_stereotype,"Off");
  RADIOBUTTON_seq=glui_stereo->add_radiobutton_to_group(RADIO_stereotype,"Successive frames");
  if(videoSTEREO==0)RADIOBUTTON_seq->disable();
  RADIOBUTTON_2=glui_stereo->add_radiobutton_to_group(RADIO_stereotype,"Left/Right");
  RADIOBUTTON_3=glui_stereo->add_radiobutton_to_group(RADIO_stereotype,"Red/Blue");
  RADIOBUTTON_4=glui_stereo->add_radiobutton_to_group(RADIO_stereotype,"Red/Cyan");
  RADIOBUTTON_5=glui_stereo->add_radiobutton_to_group(RADIO_stereotype,"Custom Red/Custom Blue");
  SPINNER_right_green2=glui_stereo->add_spinner_to_panel(PANEL_stereo_method,"green",GLUI_SPINNER_FLOAT,&right_green,STEREO_GREEN,StereoCB);
  SPINNER_right_blue2= glui_stereo->add_spinner_to_panel(PANEL_stereo_method, "blue",GLUI_SPINNER_FLOAT,&right_blue,STEREO_BLUE,StereoCB);
  ...
  PANEL_stereo_options = glui_stereo->add_panel("Stereo Options");
  fzero=SCALE2FDS(fzero);
  SPINNER_zero_parallax=glui_stereo->add_spinner_to_panel(PANEL_stereo_options,"Distance to zero parallax plane (m)",GLUI_SPINNER_FLOAT,&fzero);
  ...
  glui_stereo->add_radiobutton_to_group(RADIO_stereotype_frame,"Left eye");
  glui_stereo->add_radiobutton_to_group(RADIO_stereotype_frame,"Right eye");
  glui_stereo->add_radiobutton_to_group(RADIO_stereotype_frame,"Both eyes");
