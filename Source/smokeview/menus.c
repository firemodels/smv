...
/* --------------------------------showslice menu -------------------------- */
  ...
  if((nsliceinfo>0&&nmultisliceinfo+nfedinfo<nsliceinfo)||patchgeom_showhide==1){
...
/* -------------------------------- avatartour menu -------------------------- */
 ...
 /* --------------------------------Show Volume smoke menu -------------------------- */
  ...
  if(nsliceloaded>0||patchgeom_showhide==1){
    showhide_data = 1;
