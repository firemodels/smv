...
//*** define email address
  ...
  canshow_threshold=1;
  settmin_p=0, settmin_b=0, settmin_z=0, settmin_i=0;
  settmax_p=0, settmax_b=0, settmax_z=0, settmax_i=0;
  tmin_p=1., tmin_b=1., tmin_z=1., tmin_i=1.;
  tmax_p=0., tmax_b=0., tmax_z=0., tmax_i=0.;
  speedmax=0.0;
