...
void InitMisc(void){
  ...
  glui_curve_default.usermin = 1.0;
  glui_curve_default.usermax=0.0;
  glui_curve_default.use_usermin = 0;
  glui_curve_default.use_usermax=0;
  glui_curve_default.use_factors=0;
  glui_curve_default.factors[0] = 1.0;
  glui_curve_default.factors[1] = 0.0;
