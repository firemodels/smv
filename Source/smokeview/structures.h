...
typedef struct _keyframe {
  ...
  float  xyz_tangent_left[3],  az_tangent_left,  elev_tangent_left,  view_tangent_left[3];
  float xyz_tangent_right[3], az_tangent_right, elev_tangent_right, view_tangent_right[3];
  float az_path;
