...
test("show/hide labels", function()
    ...
    test("chid visibility", function()
        test("set", function() set_chid_visibility(true) end)
        test("get", function() return get_chid_visibility() end)
        test("equal", function()
            assert(get_chid_visibility() == true, "get does not match set")
        end)
        test("toggle", function()
    ...
    test("add custom title lines", function()
        ...
        test("add line", function()
            add_title_line(string.format("CHID Again: %s", chid))
        end)
        test("add second line", function()
            add_title_line(string.format("Viewpoint: %s", "test view"))
        end)
        test("clear custom lines", function()
            clear_title_lines()
        end)
        test("add again", function()
            add_title_line(string.format("No. Meshes: %d", nmeshes))
        end)
